...
// GreatDBBackupRecordSpec defines the desired state of GreatDBBackupRecord.
type GreatDBBackupRecordSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file

	// Foo is an example field of GreatDBBackupRecord. Edit greatdbbackuprecord_types.go to remove/update
...
// GreatDBBackupRecord is the Schema for the greatdbbackuprecords API.
